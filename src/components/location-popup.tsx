...
export function LocationPopup({ location, onClose }: LocationPopupProps) {
  ...
  const getIcon = () => {
    ...
    return <Location01Icon className="h-5 w-5" />;
  };
    ...
    >
      <div className="w-[300px] sm:w-[350px]">
          ...
          <div className="flex-1 min-w-0">
            ...
            {address && (
              <p className="text-sm text-muted-foreground truncate mt-1">
                <MapPinIcon className="h-3 w-3 inline mr-1 opacity-70" />
                {address}
              </p>
            )}
          </div>
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          >
            <Navigation01Icon className="h-4 w-4 mr-1.5" />
            Directions
          </Button>
          ...
          {properties?.external_ids?.website && (
            ...
            >
              <ExternalDriveIcon className="h-4 w-4 mr-1.5" />
              Visit Website
            </Button>
          )}
        </div>
